...
spec = do
  describe "renderingBackgroundRects" $ do
    ...
    it "respects direct nesting" $
      renderingBackgroundRects (wrapL (Background (rgba 1 1 1 1) (wrapL (Background (rgba 0 0 0 1) (pure 10))))) `shouldBe` [ Rect (Point 0 0) (Size 10 10), Rect (Point 0 0) (Size 10 10) ]
